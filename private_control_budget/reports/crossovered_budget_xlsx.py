...
class CrossoveredBudgetXslx(models.AbstractModel):
    ...
    _description='report c b budget xlsx'
    ...
    def _get_report_columns(self, report):
        res = {
            ...
            3: {'header': _('Montant engage'), 'field': 'theoritical_amount', 'width': 20},
            4: {'header': _('Montant realise'), 'field': 'practical_amount', 'width': 20},
            5: {'header': _('Montant realise sans engement'), 'field': 'practical_amount_without_invoice_document', 'width': 20},
            5: {'header': _('Montant engage without invoice'), 'field': 'engage_without_invoice', 'width': 20},
            6: {'header': _('Montant disponible'), 'field': 'available_amount', 'width': 20},
        }
