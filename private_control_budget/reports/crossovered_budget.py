...
class CrossoveredBudgetReport(models.TransientModel):
    ...
    _description='report crosvered budget'
...
class CrossoveredBudgetLines(models.TransientModel):
    ...
    _description='report de crossovere budget line'
    _inherit = 'control_budget_abstract'

    report_id = fields.Many2one('report_crossovered_budget',
        ondelete='cascade',
        index=True
    )
    ...
    practical_amount_without_invoice_document = fields.Float()
    engage_without_invoice = fields.Float()
